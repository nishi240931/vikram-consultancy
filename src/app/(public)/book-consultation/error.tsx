...
export default function BookConsultationError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Book consultation route error:", error);
  }, [error]);
    ...
    <div className="min-h-screen bg-[#FAF9F5] flex items-center justify-center p-6 text-center">
      <Card variant="glass" padding="xl" className="max-w-md w-full border-rose-200">
        ...
        <p className="text-slate-600 text-sm mb-6">
          We encountered an issue loading consultation time slots. Please try again or contact support.
        </p>
