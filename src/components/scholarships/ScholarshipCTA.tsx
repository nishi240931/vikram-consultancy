...
export interface ScholarshipCTAProps {
  scholarshipTitle: string;
}

export const ScholarshipCTA: React.FC<ScholarshipCTAProps> = ({ scholarshipTitle }) => {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 flex flex-col gap-3">
              <Badge variant="gold" size="md" className="w-fit mx-auto md:mx-0">
                <Sparkles className="w-3.5 h-3.5 mr-1" /> Financial Aid Advisory
              </Badge>
              <h2 className="text-3xl sm:text-4xl font-black font-['Outfit'] tracking-tight">
                Maximize Your Funding for <span className="text-[#D4AF37]">{scholarshipTitle}</span>
              </h2>
              <p className="text-slate-300 text-sm sm:text-base max-w-2xl font-normal leading-relaxed">
                Book a 1-on-1 session with our scholarship experts to review your academic profile, structure your winning essay, and submit your grant application.
              </p>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:items-end justify-center gap-3">
              ...
              >
                ...
                <span>Scholarship Desk: {APP_CONFIG.contact.phone}</span>
              </a>
            </div>
          </div>
        </Card>
