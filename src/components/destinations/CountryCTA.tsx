...
export const CountryCTA: React.FC<CountryCTAProps> = ({ countryName }) => {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 flex flex-col gap-3">
              <Badge variant="gold" size="md" className="w-fit mx-auto md:mx-0">
                <Sparkles className="w-3.5 h-3.5 mr-1" /> Destination Specialist Guidance
              </Badge>
              <h2 className="text-3xl sm:text-4xl font-black font-['Outfit'] tracking-tight">
                Plan Your Education in <span className="text-[#D4AF37]">{countryName}</span> Today
              </h2>
              <p className="text-slate-300 text-sm sm:text-base max-w-2xl font-normal leading-relaxed">
                Connect with our certified {countryName} education counsellors to select top universities, evaluate scholarship options, and build your application roadmap.
              </p>
            </div>
